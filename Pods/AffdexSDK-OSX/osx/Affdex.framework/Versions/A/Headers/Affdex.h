 ...
 */
- (id)initWithDelegate:(id <AFDXDetectorDelegate>)delegate usingCaptureDevice:(AVCaptureDevice *)device maximumFaces:(NSUInteger)maximumFaces __attribute__((deprecated));
...
/**
 ...
 The newly created object.
 */
- (id)initWithDelegate:(id <AFDXDetectorDelegate>)delegate usingCaptureDevice:(AVCaptureDevice *)device maximumFaces:(NSUInteger)maximumFaces faceMode:(FaceDetectorMode)faceMode;
